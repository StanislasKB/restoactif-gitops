...
var colors = ["#3073F1", "#0acf97","#000"],
    dataColors = document.querySelector("#crm-project-statistics").dataset.colors,
    eom = JSON.parse(document.querySelector("#crm-project-statistics").dataset.eom),
    ...
    options = {
        ...
        colors: (colors = (dataColors =
            document.querySelector("#monthly-target").dataset.colors)
            ? dataColors.split(",")
            : colors),
        responsive: [
            {
    ...
    colors =
        ...
        ["#3073F1", "#0acf97", "#fa5c7c", "#ffbc00"]),
    options = {
        chart: { height: 350, type: "radialBar" },
        colors: (colors = (dataColors = document.querySelector(
