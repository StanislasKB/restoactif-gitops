    ...
    <div class="row">
                        ...
                        <div id="collapse-A" class="collapse" role="tabpanel" aria-labelledby="heading-A">
                            <div class="card-body info_content">
                                ...
                                <div class="pictures magnific-gallery clearfix">
                                    ...
                                    <figure><a href="{{ Storage::url($img->file_url) }}" title="{{ $event->title }}" data-effect="mfp-zoom-in"><img src="/landing/img/thumb_detail_placeholder.jpg" data-src="{{ Storage::url($img->file_url) }}" class="lazy" alt=""></a></figure>
                                    @endforeach
                                </div>
                                <!-- /pictures -->
                                ...
                                <h2>{{ $event->user->profil()->name }}</h2>
                                <div class="row">
                                    <div class="col-md-4">
                                        <h3>Adresse</h3>
                                        <p>{{ $event->user->profil()->address  }}</p>
                                    </div>
                                    <div class="col-md-4">
                                        <h3>Galerie</h3>
                                        <div class="pictures magnific-gallery clearfix">
                                            @foreach ($event->user->profil()->images()->get() as $img)
                                            <figure><a href="{{ Storage::url($img->file_url) }}" title="{{ $event->name }}" data-effect="mfp-zoom-in"><img src="/landing/img/thumb_detail_placeholder.jpg" data-src="{{ Storage::url($img->file_url) }}" class="lazy" alt=""></a></figure>
                                            @endforeach
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <h3>Résumé</h3>
                                        {{ $event->user->profil()->description }}
                                    </div>
                                </div>
                                <!-- /row -->
                                </div>
                    ...
                    <div id="pane-B" class="card tab-pane fade" role="tabpanel" aria-labelledby="tab-B">
                        ...
                        <div id="collapse-B" class="collapse" role="tabpanel" aria-labelledby="heading-B">
                            <div class="card-body reviews">
                                <div class="row add_bottom_45 d-flex align-items-center">
                                    <div class="col-md-3">
                                        ...
                                        <div id="review_summary">
                                            ...
                                            <strong>{{$note}}</strong>
                                            {{-- <em>Superb</em> --}}
                                            <small>Basée sur {{$event->reviews()->count()}} avis</small>
                                        </div>
                                    </div>
                                ...
                                <!-- /reviews -->
                                <div class="text-end"><a href="{{ route('review.view',['id'=>$event->id,'slug'=>'event']) }}" class="btn_1">Laisser un avis</a></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-4" id="sidebar_fixed">
            <div class="box_booking">
                ...
                <div id="event-data" data-start="{{$event->start_date}}" data-end="{{$event->end_date}}"></div>
