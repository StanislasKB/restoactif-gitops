<div class="card mt-24 ">
    <div class="card-header">
        <div class="flex justify-between items-center">
            ...
            @include('dashboard.pages.profil.layouts.images.add_image_modal')


        </div>
    </div>
    <div class="flex flex-col p-6">
            @foreach ($profil->images()->get() as $image )
            <div class="flex flex-col sm:flex-row justify-between gap-8 mb-10">
                ...
                <div class="flex gap-4 mt-7 sm:mt-0">
                    <div>
                        @include('dashboard.pages.profil.layouts.images.update_image_modal')
                        @include('dashboard.pages.profil.layouts.images.delete_image_modal')
                    </div>
                </div>
            </div>
