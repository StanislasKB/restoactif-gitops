    ...
    <!-- Page Title End -->
<form action="{{route('dashboard.event.new.create')}}" method="post"  enctype="multipart/form-data" >
        ...
        <div class="lg:col-span-4 space-y-6">
            <div class="card p-6">
                ...
                <div class="flex flex-col gap-3">
                    <div class="mb-5">
                        <label for="title" class="mb-2 block">Titre de l'évènement<span class="text-red-500">*</span></label>
                        <input type="text" id="title" name="title" value="{{old('title')}}" class="form-input" placeholder="Entrez le titre" aria-describedby="input-helper-text">
                    </div>
                    ...
                    <div class="mb-5">
                        <label for="type" class="mb-2 block">Type<span class="text-red-500">*</span></label>
                    ...
                    <div class="mb-5">
                        <label for="address" class="mb-2 block">Adresse<span class="text-red-500">*</span></label>
                        <input type="text" id="address" name="address" value="{{old('address')}}" class="form-input" placeholder="Ex: Rue,Ville,Département,Pays" aria-describedby="input-helper-text">
                    </div>
                    ...
                    <div class="card mb-5">
                        <div class="card-header bg-body-tertiary">
                            <h6 class="mb-0">Images de l'évènement<span class="text-red-500">*</span></h6>
                        </div>
