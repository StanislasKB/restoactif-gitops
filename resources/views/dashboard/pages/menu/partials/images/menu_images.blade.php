<div class="card mt-24 ">
    <div class="card-header">
        <div class="flex justify-between items-center">
            ...
            @include('dashboard.pages.menu.partials.images.add_image_modal')
        </div>
    </div>
        ...
        {{-- une image  --}}
            ...
            <div class="flex flex-col sm:flex-row justify-between gap-8 mb-10">
                ...
                <div class="flex gap-4 mt-7 sm:mt-0">
                    <div>
                        @include('dashboard.pages.menu.partials.images.update_image_modal')
                        @include('dashboard.pages.menu.partials.images.delete_image_modal')
                    </div>
                </div>
            </div>
