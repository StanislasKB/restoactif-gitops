...
<div class="flex flex-col gap-28">
    <div style="margin-bottom: 50px" >
        @include('dashboard.pages.menu.partials.update_form')
    </div>

    @include('dashboard.pages.menu.partials.plats.menu_plats')
    @include('dashboard.pages.menu.partials.images.menu_images')
</div>
@endsection
@section("page_js")
...
<script src="/dashboard/assets/js/menu_dish_update.js"></script>
