    ...
    <div class="bg-gradient-to-r from-green-100 to-teal-100 dark:from-gray-700 dark:via-gray-900 dark:to-black">
        <div class="h-screen w-screen flex justify-center items-center">
            <div class="flex flex-col justify-center text-center gap-6">
                ...
                <h1 class="text-4xl font-bold tracking-tight dark:text-gray-100">Erreur du serveur</h1>
                <p class="text-base text-gray-600 dark:text-gray-300">Pourquoi ne pas essayer de rafraîchir votre page ? ou vous pouvez contacter le support.</p>
