    ...
    <div class="bg-gradient-to-r from-green-100 to-teal-100 dark:from-gray-700 dark:via-gray-900 dark:to-black">
        <div class="h-screen w-screen flex justify-center items-center">
            <div class="flex flex-col justify-center text-center gap-6">
                ...
                <p class="text-3xl font-semibold text-gray-600 dark:text-gray-100">419</p>
                <h1 class="text-4xl font-bold tracking-tight dark:text-gray-100">Session expirée</h1>
                <p class="text-base text-gray-600 dark:text-gray-300">Désolé, votre session a expiré.Veuillez recommencer </p>
